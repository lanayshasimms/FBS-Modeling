...
### Main Flow + Michigan 2025 Data Testing + Models + Python Version
...
[FBS Python Version](fbs-model.py)

This version is analogous to the work I did in RapidMiner, but in Python (with pandas/scikit-learn). The code was mostly generated by Claude and tweaked by me to help me visualize the workflow in code rather than in the RapidMiner GUI, and will serve as another format of what I have done in RapidMiner to further enhance my understanding of the project. I also plan to continue to use the code as a building block for implementing more difficult algorithms that are also appropriate for the problem setting I have created. The code does not produce the same results as the RapidMiner code as a result of differences in random seeding and other algorithmic differences in RapidMiner/Python.
